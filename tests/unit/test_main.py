...
def make_state(tmp_path):
    ...
    state = ServerState(
        ...
        start_listening_sound="/sounds/start-listening.flac",
        ...
        button_double_press_sound="/sounds/button-double-press.flac",
        button_triple_press_sound="/sounds/button-triple-press.flac",
        button_long_press_sound="/sounds/button-long-press.flac",
        preferences=prefs,
